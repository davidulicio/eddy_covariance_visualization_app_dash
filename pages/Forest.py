...
df_fst = pd.read_csv(DATA_PATH.joinpath("forest_daily_merged_flux.csv"), index_col='TIMESTAMP')  # Reading data
...
# ])
layout = html.Div([
    html.H1('Forest Senda Darwin, Chiloé, IEB',
            style={"textAlign": "center"}),
